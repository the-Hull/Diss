...
The following two plots show the logged biomass density [$kg/km^{2}$] for the aseasonal environment in Cell0 (**left**) and the seasonal environment in Cell1 (**right**). The y-axes are scaled identically for easy comparison.
...
legend("center", legend = cols$FGroup, col = cols$Color, lwd = 2 , bty="n", horiz=T)
...
This set of plots compares the logged biomass density of by trophic group for each experiment in the aseasonal (**top**) and seasonal (**bottom**) environment.
