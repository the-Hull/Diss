...
bmdlab <- "\\textbf{$\\log_{10}$ Autotroph Biomass Density \\\ $[kg\\cdot km^{-2}]$}"
...
# x11()
#
# tikz("../WriteUp/Dissertation/res/fig/comp_effects.tex",
#      width = 8,
#      height = 8,
#      standAlone = T,
#      timestamp = T)

# png("../presentation/fig/comp_effects.png", width = 10,height = 8,units = "in", res=300,
#     bg="transparent")
...
dat <- comp_boxplot(statsAov, statsDensAov,cutoff=1080,type = NULL,
             resp = c("autotroph","herbivore"),logscale = T,
