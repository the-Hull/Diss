...
\add{total median biomass density for each system?}
...
Median herbivore biomass and abundance densities were compared between experiments (1 to 8) using a Krusikal-Wallis test with subsequent multiple comparison analysis (\add{adjusted p value?} $\alpha = 0.05$; cf. Table~\ref{tab:chap:res:dyn:autoBMD} and Table~\ref{tab:chap:res:dyn:herbIND}, respectively) for each system. 
