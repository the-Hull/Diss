...
as expected, biomass densities in the temperate ecosystem followed seasonal cycles, as indicated by confidence intervals in Figure~\ref{fig:chap:res:dyn:comp} (cf. Figure~\add{APPENDIX TS}) 
