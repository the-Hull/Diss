...
Biodiversity is a major determinant of ecosystem functioning, expressed through processes such as primary production, nutrient cycling, energy transfer between and within trophic levels \citep[][]{Tilman2014}, its current -  and predicted \citep{Urban2015} - loss therefore threatens not only the persistence of ecosystems, but also human well-being due to our dependence on services we derive from nature \cite{MEA2005,Cardinale2012}.
\\\\
